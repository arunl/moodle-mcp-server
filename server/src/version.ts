 ...
 * - COMMIT_SHA: Git commit hash (set by CI/CD)
 * - BUILD_DATE: Build timestamp (set by CI/CD)
 */
...
export const versionInfo = {
  ...
  commit: (process.env.COMMIT_SHA || 'dev').slice(0, 7),
  
  /** Full Git commit SHA */
  commitFull: process.env.COMMIT_SHA || 'development',
  
  /** Build date from CI/CD, or startup time */
